...
# 1950 
pd_sb_1950 <- read.csv("Data/Phylo_div_results/PD_SB_1950.csv")
mpd_sb_1950 <- read.csv("Data/Phylo_div_results/MPD_SB_1950.csv")
mntd_sb_1950 <- read.csv("Data/Phylo_div_results/MNTD_SB_1950.csv")

pd_sf_1950 <- read.csv("Data/Phylo_div_results/PD_SF_1950.csv")
mpd_sf_1950 <- read.csv("Data/Phylo_div_results/MPD_SF_1950.csv")
mntd_sf_1950 <- read.csv("Data/Phylo_div_results/MNTD_SF_1950.csv")

pd_uh_1950 <- read.csv("Data/Phylo_div_results/PD_UH_1950.csv")
mpd_uh_1950 <- read.csv("Data/Phylo_div_results/MPD_UH_1950.csv")
mntd_uh_1950 <- read.csv("Data/Phylo_div_results/MNTD_UH_1950.csv")

pd_a_1950 <- read.csv("Data/Phylo_div_results/PD_A_1950.csv")
mpd_a_1950 <- read.csv("Data/Phylo_div_results/MPD_A_1950.csv")
mntd_a_1950 <- read.csv("Data/Phylo_div_results/MNTD_A_1950.csv")


# 2014 (using only reduced datasets)
pd_sb_2014 <- read.csv("Data/Phylo_div_results/PD_SB_2014_reduced.csv")
mpd_sb_2014 <- read.csv("Data/Phylo_div_results/MPD_SB_2014_reduced.csv")
mntd_sb_2014 <- read.csv("Data/Phylo_div_results/MNTD_SB_2014_reduced.csv")

pd_sf_2014 <- read.csv("Data/Phylo_div_results/PD_SF_2014_reduced.csv")
mpd_sf_2014 <- read.csv("Data/Phylo_div_results/MPD_SF_2014_reduced.csv")
mntd_sf_2014 <- read.csv("Data/Phylo_div_results/MNTD_SF_2014_reduced.csv")

pd_uh_2014 <- read.csv("Data/Phylo_div_results/PD_UH_2014_reduced.csv")
mpd_uh_2014 <- read.csv("Data/Phylo_div_results/MPD_UH_2014_reduced.csv")
mntd_uh_2014 <- read.csv("Data/Phylo_div_results/MNTD_UH_2014_reduced.csv")

pd_a_2014 <- read.csv("Data/Phylo_div_results/PD_A_2014_reduced.csv")
mpd_a_2014 <- read.csv("Data/Phylo_div_results/MPD_A_2014_reduced.csv")
mntd_a_2014 <- read.csv("Data/Phylo_div_results/MNTD_A_2014_reduced.csv")
...
phylo_df <- rbind(phylo_1950, phylo_2014)

phylo_df <- phylo_df %>% 
  rename(community = community.x)

write.csv(phylo_df, "Data/Phylo_div_results/all_phylo_div_results.csv")

# make data frames for each community type -------

sb_df <- phylo_df %>% filter(community %in% "sagebrush")
sf_df <- phylo_df %>% filter(community %in% "spruce-fir")
uh_df <- phylo_df %>% filter(community %in% "upland-herb")
a_df <- phylo_df %>% filter(community %in% "alpine")
...
phylo_paired_df <- phylo_paired_df[!is.na(phylo_paired_df$SES_change),]

# save as
write.csv(phylo_paired_df, "Data/Phylo_div_results/all_PD_paired.csv")
